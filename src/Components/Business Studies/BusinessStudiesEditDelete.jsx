...
//     // Use POST for both (changed from PUT to POST)
//     const method = "POST";
...
//     setEditId(item.id);
//     setPreviewImage(
//       `${ImageBaseurl}${item.image.startsWith("/") ? item.image.substring(1) : item.image}`,
//     );
//     setImage(null);
//   };
          ...
          <tbody>
            {BusinessStudiesData.map((item) => (
              <tr key={item.id}>
                ...
                <td className="border px-3 py-2">{item.text}</td>
                <td className="border px-3 py-2">
                  {/* ==================== CHANGE 2: UPDATED IMAGE DISPLAY ==================== */}
                  {item.image && (
                    <img
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded p-2"
              />
              {/* ==================== CHANGE 3: ADDED ERROR HANDLING FOR PREVIEW IMAGE ==================== */}
              {previewImage && (
                <img
                  src={previewImage}
                  alt="preview"
